        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead className="bg-gray-50">
              <tr>
                {['Name', 'Student ID', 'Grade', 'Class', 'Allergies', 'Actions'].map((header) => (
              ...
              <tr key={student.id} className="hover:bg-gray-50">
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                  <div className="flex space-x-3">
                    ...
                    {/* Medical Icon
                    <button
                      onClick={() => console.log('Medical records:', student.id)}
                      className="text-purple-600 hover:text-purple-900 transition duration-200 p-1 rounded hover:bg-purple-50"
