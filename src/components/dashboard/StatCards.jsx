...
const StatCard = ({ title, value, icon: Icon, color = "blue" }) => {
  ...
  return (
    <div className={`p-6 rounded-lg border-2 ${colorClasses[color]} flex justify-between items-center`}>
      <div>
    ...
    return (
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        {STAT_CARDS_CONFIG.map((config) => (
          <div key={config.key} className="p-6 rounded-lg border-2 bg-gray-100 animate-pulse">
